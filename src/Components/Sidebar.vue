  ...
  <nav id="sidebar" class="w-64 h-screen bg-[#1a1a1a] border-r border-gray-800 flex flex-col transition-all">
    ...
    <div class="p-6 mb-4">
      <router-link to="/" class="flex items-center gap-3 no-underline">
        <div
          class="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center text-white shadow-lg shadow-blue-900/20">
      ...
      <ul class="flex flex-col gap-1 p-0 list-none">
        <li>
          <router-link to="/play"
            ...
            <i class="bi bi-play-circle-fill"
              :class="isActive('/play') ? 'text-blue-400' : 'text-gray-500 group-hover:text-gray-300'"></i>
        ...
        <li>
          <router-link to="/biblioteca"
            ...
            <i class="bi bi-collection-play"
              :class="isActive('/biblioteca') ? 'text-blue-400' : 'text-gray-500 group-hover:text-gray-300'"></i>
        ...
        <li>
          <router-link to="/wishlist"
            ...
            class="flex items-center gap-3 px-3 py-2 rounded-md no-underline transition-all group">
            <i class="bi bi-star"
              :class="isActive('/wishlist') ? 'text-blue-400' : 'text-gray-500 group-hover:text-gray-300'"></i>
            <span class="text-sm font-medium">Wishlist</span>
          </router-link>
        </li>

        <li>
          <router-link to="/namorada"
            :class="[isActive('/namorada') ? 'bg-gray-800 text-blue-400' : 'text-gray-400 hover:bg-gray-800/50 hover:text-gray-200']"
            class="flex items-center gap-3 px-3 py-2 rounded-md no-underline transition-all group">
            <i class="bi bi-heart"
              :class="isActive('/namorada') ? 'text-blue-400' : 'text-gray-500 group-hover:text-gray-300'"></i>
            <span class="text-sm font-medium">Area Namorada</span>
          </router-link>
        </li>
      </ul>
    </div>
